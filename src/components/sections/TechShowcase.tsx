...
const CATEGORIES: {
...
}[] = [
  {
    ...
    bg: 'bg-violet-500/8',
    pillBg: 'bg-violet-500/8 border-violet-500/20 text-violet-300',
  ...
  },
  {
    ...
    bg: 'bg-blue-500/8',
    pillBg: 'bg-blue-500/8 border-blue-500/20 text-blue-300',
  ...
  },
  {
    ...
    bg: 'bg-emerald-500/8',
    pillBg: 'bg-emerald-500/8 border-emerald-500/20 text-emerald-300',
  ...
  },
  {
    ...
    bg: 'bg-amber-500/8',
    pillBg: 'bg-amber-500/8 border-amber-500/20 text-amber-300',
