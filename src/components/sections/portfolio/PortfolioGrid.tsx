...
const PROJECTS_CONFIG: {
  ...
  { id: 'shawarmania', category: 'landing',  tech: ['Next.js 16', 'Framer Motion', 'Tailwind CSS v4', 'next-intl', 'TypeScript', 'Schema.org JSON-LD'], gradient: 'from-orange-500 via-red-500 to-rose-600', year: '2026', liveUrl: 'https://shawarma-demo-brasov.vercel.app', image: { light: '/images/projects/shawarmania-by-tata-radu-light.avif', dark: '/images/projects/shawarmania-by-tata-radu-dark.avif' } },
  { id: 'foodie',     category: 'landing',   tech: ['Next.js 16', 'Framer Motion', 'Tailwind CSS v4', 'next-intl', 'Schema.org JSON-LD'], gradient: 'from-amber-500 via-orange-500 to-red-500', year: '2026', liveUrl: 'https://frontend-demo-restaurant.vercel.app', image: { light: '/images/projects/foodie-brasov-light.avif', dark: '/images/projects/foodie-brasov-dark.avif' } },
